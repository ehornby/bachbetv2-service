...
namespace BachBetV2.Infrastructure.Migrations
{
    ...
    [Migration("20230531153848_AddingPushSubscription")]
    partial class AddingPushSubscription
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BachBetV2.Infrastructure.Database.Entities.PushSubscriptionEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BachBetV2.Infrastructure.Database.Entities.PushSubscriptionEntity", b =>
                {
                    b.HasOne("BachBetV2.Infrastructure.Database.Entities.UserEntity", "User")
                        .WithOne("PushSubscription")
                        .HasForeignKey("BachBetV2.Infrastructure.Database.Entities.PushSubscriptionEntity", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
